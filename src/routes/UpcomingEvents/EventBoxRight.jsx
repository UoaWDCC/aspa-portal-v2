...
export default function EventBoxLeft() {
  return (
    <div className="w-4/5 h-1/2 text-white flex flex-col md:flex-row md:flex-row-reverse bg-neutral-900 overflow-hidden last:mb-10">
      ...
      <div className="relative border-solid border-2 border-white md:basis-2/3 flex flex-col">
